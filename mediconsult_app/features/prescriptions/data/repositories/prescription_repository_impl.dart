...
class PrescriptionRepositoryImpl implements PrescriptionRepository {
  ...
  PrescriptionRepositoryImpl({FirebaseFirestore? firestore})
  ...
  Future<Either<Failure, List<Prescription>>> getConsultationPrescriptions(
    ...
    try {
      ...
      return Left(ServerFailure('Failed to get consultation prescriptions: $e'));
    }
  }
      ...
      return prescriptionResult.fold(
        ...
        (prescription) async {
          ...
          if (!prescription.canRefill) {
            return Left(ServerFailure('Refill not allowed for this prescription'));
          }
