...
class VideoCallBloc extends Bloc<VideoCallEvent, VideoCallState> {
  ...
  VideoCallBloc(
    InitializeVideoCall initializeVideoCall,
  ...
  Future<void> _onInitializeRequested(
    ...
    final result =
        await _initializeVideoCall(const InitializeParams(appId: ''));
  ...
  Future<void> _onJoinRequested(
    ...
    final result = await _joinVideoCall(
      JoinCallParams(
        token: event.token,
  ...
  Future<void> _onAudioToggled(
    ...
    await _toggleAudio(ToggleAudioParams(enabled: newAudioState));
  ...
  Future<void> _onVideoToggled(
    ...
    await _toggleVideo(ToggleVideoParams(enabled: newVideoState));
