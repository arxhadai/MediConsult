...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, String>> signInWithPhone({
    ...
    try {
      final verificationId =
          await _remoteDatasource.signInWithPhone(phoneNumber);
  ...
  Future<Either<Failure, User>> authenticateWithBiometric() async {
    try {
      ...
      final didAuthenticate =
          await _localDatasource.authenticateWithBiometric();
      if (!didAuthenticate) {
  ...
  Future<bool> isBiometricAvailable() async {
    return _localDatasource.isBiometricAvailable();
  }
  ...
  Future<void> _cacheUserSession(
      UserModel user, AuthProviderType providerType) async {
    await _localDatasource.cacheUser(user);
    await _localDatasource.storeLastLoginTime(DateTime.now());
